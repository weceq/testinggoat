...
class NewVisitorTest(unittest.TestCase):
    ...
    def test_cal_start_and_retrieve_it_later(self):
        ...
        # Edith wonders wheather the site will remember her list. Then she sees that
        # the site has generated a unique URL for her -- there is some exlplanatory
        # text to that efect.
